...
class cource_following_learning_node:
    def __init__(self):
        ...
        self.pro = "20250406_17:11:18"   #元のー>"omni_0614" #ここの名前を走行したdataの名前に変えること！
        ...
        self.learn_no = 4000
        self.count = 0
        self.data =649 #データの数！　angのcsvファイルの最大数かな？ 
    ...
    def learn(self):
        ...
        # for k in range(self.data):
            ...
            self.dl.make_dataset(img_right, target_ang + 0.0134)

            self.dl.make_dataset(img_right_left, target_ang + 0.057)
            self.dl.make_dataset(img_right_center, target_ang + 0.182)
            self.dl.make_dataset(img_right_right, target_ang + 0.244)
