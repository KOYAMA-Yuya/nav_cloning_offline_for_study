...
class CourseFollowingLearningNode:
    def __init__(self):
        ...
        self.pro = "20250407_12:06:35"  # データセットの識別名
    ...
    def load_images(self, index):
        shifts = {"-5": -0.25, "0": 0, "+5": 0.25}
        img_types = ["left", "center", "right"]
        images = []
        
        for img_type in img_types:
            for shift, angle_shift in shifts.items():
                img_file = f"{self.img_path}{img_type}{index}_{shift}.jpg"
